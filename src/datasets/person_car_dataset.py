...
class PersonCarDataset(Dataset):
    ...
    def __init__(self, root_dir, split="train", transform=None):
        ...
        self.image_files = natsort.natsorted([f for f in os.listdir(self.image_dir) if f.endswith(('.png','PNG', '.jpg', '.jpeg', '.JPG'))])# Updated the hardcoded '.JPG' to support additional image formats
