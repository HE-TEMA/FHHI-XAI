...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data-path', default='./data/Tema_integration.yaml', type=str, help='path of dataset')
    ...
    parser.add_argument('--stop_aug_last_n_epoch', default=10, type=int, help='stop strong aug at last n epoch, neg value not stop, default 15')
    ...
    parser.add_argument('--bs_per_gpu', default=1, type=int, help='batch size per GPU for auto-rescale learning rate, set to 16 for P6 models')
