...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data', type=str, default='/media/data/evlachos/TurboSVM-FL/YOLOV6/data/visdrone_twoclasses_first.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', type=str, default='/media/data/evlachos/TurboSVM-FL/YOLOV6/turbo_yolo_fl/federated_output_decentralized/5_clients_random_2_decentralized_paper_alpha=4/round_1/client_0/client_0/weights/best_ckpt.pt', help='model.pt path(s)')
